...
public class ShardedJedisSentinelPool extends Pool<ShardedJedis> {
     ...
     */
    public ShardedJedisSentinelPool(final SupportKeyValueNotEqualObject supportKeyValueNotEqualObject, final GenericObjectPoolConfig poolConfig, final String password) {
        this(supportKeyValueNotEqualObject.getMasters(), supportKeyValueNotEqualObject.getSentinels(),
                poolConfig, password);
    }
            ...
            while (!fetched && sentinelRetry < MAX_RETRY_SENTINEL) {
                for (String sentinel : sentinels) {
                    ...
                    try {
                        ...
                        if (master == null) {
                            /** 从RedisSentinel获取Master信息，如果用这个类，且没有搭建Redis HA集群，在这步验证不通过 **/
                ...
                try {
                    jedis.subscribe(new JedisPubSubAdapter() {
                        ...
                        public void onMessage(String channel, String message) {
                            ...
                            /**
                             * 消息格式
                             * mymaster 127.0.0.1 6379 127.0.0.1 6378
                             * 1        2         3    4         5
                             */
